                  ...
                  <div className="section">
                    ...
                    <p>
                      <button
                        className="btn"
                        onClick={() =>
                          (window.location.href = `https://github.com/abaddon-x/seg/raw/master/docs/quotation/xlsx/${quotation.serie}.xlsx`)
                        }
                        download
                      >
                        GET XLSX
                      ...
                      <button
                        className="btn"
                        onClick={() =>
                          (window.location.href = `https://github.com/abaddon-x/seg/raw/master/docs/quotation/pdf/${quotation.serie}.pdf`)
                        }
                        download
                      >
                        GET PDF
