                  ...
                  <div className="section">
                    ...
                    <p>
                      <button
                        className="btn"
                        onClick={() =>
                          (window.location.href = `https://github.com/abaddon-x/seg/raw/master/docs/order/xlsx/${order.serie}.xlsx`)
                        }
                        download
                      >
                        GET XLSX
                      ...
                      <button
                        className="btn"
                        onClick={() =>
                          (window.location.href = `https://github.com/abaddon-x/seg/raw/master/docs/order/pdf/${order.serie}.pdf`)
                        }
                        download
                      >
                        GET PDF
